...
public final class ValidationRulesModule extends AbsModule<ExtAsync, ExtRxJava> {
    ...
    public BusinessValidationRuleList list(BusinessValidationRuleFilter filter) {
        return executeSyncApiCall(api.listValidationRules(filter != null ? filter.asMap() : new HashMap<>()));
    }
    ...
    public BusinessValidationRuleAssignment createAssignment(String id, CreateBusinessValidationRuleAssignment
            assignment) {
        return executeSyncApiCall(api.createValidationRuleAssignment(id, assignment));
    }

    public BusinessValidationRuleAssignmentList listAssignments(String id, BusinessValidationRuleAssignmentFilter
            filter) {
        return executeSyncApiCall(api.listValidationRuleAssignments(id, filter != null ? filter.asMap() : new HashMap<>()));
    }
    ...
    public class ExtAsync extends AbsModule.Async {
        ...
        public void update(UpdateBusinessValidationRule
                                   validationRule, VoucherifyCallback<BusinessValidationRule> callback) {
        ...
        public void list(BusinessValidationRuleFilter
                                 filter, VoucherifyCallback<BusinessValidationRuleList> callback) {
            RxUtils.subscribe(executor, rx().list(filter), callback);
        }

        public void createAssignment(String id, CreateBusinessValidationRuleAssignment
                assignment, VoucherifyCallback<BusinessValidationRuleAssignment> callback) {
            RxUtils.subscribe(executor, rx().createAssignment(id, assignment), callback);
        }

        public void deleteAssignment(String validationRuleId, String
                assignmentId, VoucherifyCallback<Void> callback) {
            RxUtils.subscribe(executor, rx().deleteAssignment(validationRuleId, assignmentId), callback);
        }

        public void listAssignments(String id, BusinessValidationRuleAssignmentFilter
                filter, VoucherifyCallback<BusinessValidationRuleAssignmentList> callback) {
    ...
    public class ExtRxJava extends AbsModule.Rx {
        ...
        public Observable<BusinessValidationRuleAssignment> createAssignment(final String id,
                                                                             final CreateBusinessValidationRuleAssignment assignment) {
        ...
        public Observable<BusinessValidationRuleAssignmentList> listAssignments(final String id,
                                                                                final BusinessValidationRuleAssignmentFilter filter) {
        ...
        public Observable<Void> deleteAssignment(final String validationRuleId,
