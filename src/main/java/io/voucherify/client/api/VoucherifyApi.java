...
public interface VoucherifyApi {
    ...
    Call<Void> deleteCampaign(@Path("name") String campaignName, @QueryMap Map<String, Object> params);
    ...
    Call<BusinessValidationRule> createValidationRules(@Body CreateBusinessValidationRule validationRule);
    ...
    Call<BusinessValidationRule> updateValidationRules(@Path("id") String id, @Body UpdateBusinessValidationRule validationRule);

    @DELETE("validation-rules/{id}")
    Call<Void> deleteValidationRules(@Path("id") String id);

    @POST("validation-rules/{id}/assignments")
    Call<BusinessValidationRuleAssignment> createValidationRuleAssignment(@Path("id") String id, @Body CreateBusinessValidationRuleAssignment assignment);

    @DELETE("validation-rules/{validationRuleId}/assignments/{assignmentId}")
    Call<Void> deleteValidationRuleAssignment(@Path("validationRuleId") String validationRuleId, @Path("assignmentId") String assignmentId);

    @GET("validation-rules/{id}/assignments")
    Call<BusinessValidationRuleAssignmentList> listValidationRuleAssignments(@Path("id") String id, @QueryMap Map<String, Object> filter);
    ...
    Call<ListRewardAssignmentsResponse> listRewardAssignments(@Path("id") String id, @QueryMap Map<String, Object> filter);

    @POST("rewards/{id}/assignments")
    Call<RewardAssignmentResponse> createRewardAssignment(@Path("id") String id, @Body CreateRewardAssignment createRewardAssignment);

    @PUT("rewards/{id}/assignments/{assignmentId}")
    Call<RewardAssignmentResponse> updateRewardAssignment(@Path("id") String id, @Path("assignmentId") String assignmentId, @Body UpdateRewardAssignment updateRewardAssignment);

    @DELETE("rewards/{id}/assignments/{assignmentId}")
    Call<Void> deleteRewardAssignment(@Path("id") String id, @Path("assignmentId") String assignmentId);
    ...
    @PUT("loyalties/{id}")
    Call<CampaignResponse> updateLoyaltyCampaign(@Path("id") String id, @Body UpdateCampaign updateCampaign);
    ...
    Call<ListRewardAssignmentsResponse> listLoyaltyRewardAssignments(@Path("id") String id, @QueryMap Map<String, Object> filter);

    @POST("loyalties/{id}/rewards")
    Call<RewardAssignmentResponse> createLoyaltyRewardAssignment(@Path("id") String id, @Body List<CreateRewardAssignment> createRewardAssignment);

    @PUT("loyalties/{id}/assignments/{assignmentId}")
    Call<RewardAssignmentResponse> updateLoyaltyRewardAssignment(@Path("id") String id, @Path("assignmentId") String assignmentId, @Body UpdateRewardAssignment updateRewardAssignment);

    @DELETE("loyalties/{id}/rewards/{assignmentId}")
    Call<Void> deleteLoyaltyRewardAssignment(@Path("id") String id, @Path("assignmentId") String assignmentId);

    @GET("loyalties/{id}/earning-rules")
    Call<ListEarningRulesResponse> listLoyaltyEarningRules(@Path("id") String id, @QueryMap Map<String, Object> filter);

    @POST("loyalties/{id}/earning-rules")
    Call<EarningRuleResponse> createLoyaltyEarningRule(@Path("id") String id, @Body List<CreateEarningRule> create);

    @PUT("loyalties/{id}/earning-rules/{ruleId}")
    Call<EarningRuleResponse> updateLoyaltyEarningRule(@Path("id") String id, @Path("ruleId") String ruleId, @Body UpdateEarningRule update);
    ...
    Call<VouchersResponse> listLoyaltyMembers(@Path("id") String id, @QueryMap Map<String, Object> filter);
    ...
    Call<io.voucherify.client.model.loyalties.response.AddBalanceResponse> addLoyaltyBalance(@Path("id") String id, @Path("memberId") String memberId, @Body io.voucherify.client.model.loyalties.AddBalance addBalance);

    @POST("loyalties/{id}/members/{memberId}/redemption")
    Call<RedeemVoucherResponse> redeemLoyaltyReward(@Path("id") String id, @Path("memberId") String memberId, @Body RedeemReward redeemReward);
}
