...
public class DistributionsModuleTest extends AbstractModuleTest {
  ...
  public void shouldListPublications() {
    ...
    assertThat(request.getPath())
        .isEqualTo(
            "/publications?filters%5Bsome_field%5D%5Bconditions%5D%5B%24has_value%5D%5B0%5D=sth&filters%5Bsome_field%5D%5Bconditions%5D%5B%24has_value%5D%5B1%5D=sth2");
    assertThat(request.getMethod()).isEqualTo("GET");
  }
