...
public class ProductsModule extends AbsModule<ExtAsync, ExtRxJava> {
    ...
    public class ExtAsync extends AbsModule.Async {
        ...
        public void delete(String id, DeleteProductParams params, VoucherifyCallback<Irrelevant> callback) {
        ...
        public void deleteSKU(
                String productId, String skuId, DeleteSKUParams params, VoucherifyCallback<Irrelevant> callback) {
