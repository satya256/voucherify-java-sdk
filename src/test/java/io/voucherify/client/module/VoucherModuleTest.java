...
public class VoucherModuleTest extends AbstractModuleTest {
  ...
  public void shouldListVouchersByCustomFilters() throws Exception {
    ...
    assertThat(list).isNotNull();
    RecordedRequest request = getRequest();
    assertThat(request.getPath()).isEqualTo("/vouchers?limit=10&campaign=some-campaign&%5Bfilters%5D%5Bmetadata.some-key%5D%5Bconditions%5D%5B%24is%5D=123&page=5&category=some-category&%5Bfilters%5D%5Bactive%5D%5Bconditions%5D%5B%24active%5D=true");
    assertThat(request.getMethod()).isEqualTo("GET");
  }
  ...
  public void shouldListVouchersAsync() throws Exception {
    ...
    assertThat(request.getPath())
        .isEqualTo("/vouchers?limit=10&campaign=some-campaign&page=5&category=some-category");
    assertThat(request.getMethod()).isEqualTo("GET");
  }
